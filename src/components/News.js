...
export class News extends Component {
    ...
    articles = [
        ...
        title:
            "From Malinga to Sangakkara: How cricket fraternity reacted to Sri Lanka's economic crisis",
        description:
            "Lasith Malinga, Mahela Jayawardene, Kumar Sangakkara, Bhanuka Rajapaksa, and Wanindu Hasaranga have expressed their solidarity with the people of Sri Lanka in the wake of the country's worst economic crisis since its independence. Former Sri Lanka captain San…",
        ...
        content:
            "Aus vs Eng, WC final: Alyssa Healy breaks Gilchrist's record, surpasses Richards and Ponting in elite list",
        },
        {
        source: {
            id: "bbc-sport",
    ...
    async updateNews(pageNo) {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=ae3c10c7071b4d068b7a245f1f3b59ee&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    ...
    render() {
        ...
        <div className="container my-3">
            <h2 className="text-center"> NewsMonkey - Top {this.capitalizedFirstLetter(this.props.category)} Headlines</h2>
